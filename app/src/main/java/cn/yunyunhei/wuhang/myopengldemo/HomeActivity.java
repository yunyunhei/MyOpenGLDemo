...
import cn.yunyunhei.wuhang.myopengldemo.wuwang.render.FGLViewActivity;
...
//        add("光照",LightActivity.class);
    ...
    private class MenuAdapter extends RecyclerView.Adapter<MenuAdapter.MenuHolder>{
        ...
        public MenuHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new MenuHolder(getLayoutInflater().inflate(R.layout.item_buttom,parent,false));
        }
        ...
        class MenuHolder extends RecyclerView.ViewHolder{
            ...
            MenuHolder(View itemView) {
                ...
                mBtn.setOnClickListener(HomeActivity.this);
            }
